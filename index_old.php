...
?>
        ...
        <td class="feature" valign="top" style="background-color:white;" width="270" valign="top">
        	...
        	<p>
        		<!-- Montessori Madness video link. -->
        		<a href="http://www.youtube.com/watch?v=GcgN0lEh5IA"><img src="images/video-Mont-Mad.jpg" alt="Video, Montessori Madness" width="265" height="161" border="0"></a>
        	</p>
    ...
    <tr><!-- White space -->
        ...
        <!--EcoSchools Newsletter link-->
        	<br>
        	<img align="left" src="images/EcoSchool-banner-Mini.gif" style="margin-right:7px;" height="35" width="120" alt="View newsletter" border="0">
        ...
        <td colspan="3" valign="top">
			...
			<table style="text-align: left; width: 100%;" border="0" cellpadding="0" cellspacing="0">
				...
				<tr><!--Logos-->
					...
					<td style="vertical-align: top;" width="48%">
						<a href="http://www.ontarioecoschools.org/certification" target="_blank"><img src="images/eco-seal.gif" border="0" height="125" width="125" align="left" hspace="3"></a>
						We have gold status with the <a href="http://www.ontarioecoschools.org/" target="_blank">Ontario EcoSchools</a> environmental education program.<!-- A school can be recognized for its annual achievement in 4 key areas: energy conservation, waste minimization, ecological literacy and school ground greening.--></p>
					</td>
				</tr>
				<tr><!--Spacer row-->
